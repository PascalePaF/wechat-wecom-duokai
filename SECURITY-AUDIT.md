...
本机 Microsoft Defender 服务处于禁用状态；应用户要求，改用正在运行的 Kaspersky 21.26 完成扫描。旧版 EXE 处理 1 个对象、检测 0、可疑 0、错误 0；V1.0.0 发布目录处理 27 个对象、检测 0、可疑 0、错误 0；V1.0.1 发布目录处理 29 个对象、检测 0、可疑 0、错误 0。完整日志随对应 GitHub Release 提供。
...
- V1.0.1 发布目录扫描结果：处理 29、正常 29、检测 0、可疑 0、错误 0，退出码 0。
